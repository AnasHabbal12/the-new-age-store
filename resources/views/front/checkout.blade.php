                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input type="text" name="address[billing][email]" placeholder="First Name"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input type="text" name="address[billing][street_address]" placeholder="Street Address"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input type="text" name="address[billing][postal_code]" placeholder="Postal Code"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.select lable="" name="address[billing][country]" selected="" :options="$countries"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Email Address</label>
                                                    <div class="form-input form">
                                                        <x-form.input type="text" name="address[shipping][email]" placeholder="First Name"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    <label>Street Address</label>
                                                    <div class="form-input form">
                                                        <x-form.input type="text" name="address[shipping][street_address]" placeholder="Street Address"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Post Code</label>
                                                    <div class="form-input form">
                                                        <x-form.input type="text" name="address[shipping][postal_code]" placeholder="Postal Code"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.select lable="" name="address[shipping][country]" selected="" :options="$countries"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="steps-form-btn button">
                                                    ...
                                                    <button class="btn btn-alt" type="submit">Save & Continue</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>

            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                    <form class="card login-form" action="{{route('login')}}" method="post">
                        ...
                        <div class="card-body">
                            <div class="title">
                                @if($errors->has(config('fortify.usernmame')))
                                 <div class="alert alert-danger">Errors :
                                    {{ $errors->first(config('fortify.usernmame')) }}
                                 </div>
                                @endif
                                <h3>Login Now</h3>
                            ...
                            <div class="form-group input-group">
                                <label for="reg-fn">Email or Phone Number or User Name</label>
